...
use crate::{Bell, Change, MultiplicationIterator, MusicScoring, Stage, Touch, Transposition};
...
pub trait TouchIterator<'a> {
    ...
    fn chain<I: TouchIterator<'a>>(&'a self, other: &'a I) -> ChainedTouchIterator<Self, I>
    where
        Self: Sized,
    {
...
impl<'a, I: TouchIterator<'a>, J: TouchIterator<'a>> TouchIterator<'a>
    for ChainedTouchIterator<'a, I, J>
{
...
impl<'a, I: TouchIterator<'a>, T: Transposition> TouchIterator<'a>
    for TransfiguredTouchIterator<'a, I, T>
{
    ...
    fn leftover_change_iter(&self) -> Self::LeftoverChangeIter {
        MultiplicationIterator::new(
            &self.transposition.slice(),
            self.iterator.leftover_change_iter(),
        )
    }
}
